  ...
  return (
    <div className="bg-white rounded-lg p-6 border border-gray-100 dark:bg-slate-900 dark:border-slate-800">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-lg font-semibold text-gray-900 flex gap-1 items-center dark:text-gray-100">
          Top Selling Items{' '}
          <svg
            width="16"
            height="16"
        ...
        <div className="border rounded-[9px] py-3 px-2 border-gray-200 dark:border-slate-700">
          <svg
            width="13"
            height="4"
            viewBox="0 0 13 4"
        ...
        <div className="min-w-0 flex-1 space-y-2 lg:space-y-3">
          {chartData.map((item, idx) => (
            <div key={idx} className="flex items-center justify-between gap-2">
              ...
              <span className="text-sm font-semibold text-gray-900 flex-shrink-0 dark:text-gray-100">
                {item.value} Sales
              </span>
            </div>
          ))}
