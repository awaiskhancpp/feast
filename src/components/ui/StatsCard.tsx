    ...
    <div className="bg-white rounded-lg p-6 border border-gray-100 dark:bg-slate-900 dark:border-slate-800">
      <div className="flex justify-between items-center">
        <div className="flex  items-center gap-2 ">
          <h3 className="text-gray-500 text-sm font-medium dark:text-slate-400">{label}</h3>
        ...
        >
          <path
            ...
            fill="currentColor"
            className="text-[#888888] dark:text-slate-500"
          />
        </svg>
      </div>
      ...
      {trend && (
        <div className="flex items-center gap-2">
          ...
          <div
            className={`flex gap-2 border  px-2 py-1 rounded-full ${trend.direction === 'up' ? 'text-green-700 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-950/40 dark:border-green-900' : 'text-red-700 bg-red-50 border-red-200 dark:text-red-400 dark:bg-red-950/40 dark:border-red-900'} `}
          >
            <Image
            ...
            <span
              className={`text-xs font-semibold   ${
                trend.direction === 'up'
                  ? 'text-green-700 bg-green-50 dark:text-green-400 dark:bg-transparent'
                  : 'text-red-700 bg-red-50 dark:text-red-400 dark:bg-transparent'
              }`}
            >
              {trend.percentage}%
            </span>
